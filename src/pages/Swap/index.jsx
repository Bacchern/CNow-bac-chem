                        ...
                        <div className="table-main">
                            ...
                            <div className="table-main_content">
                                ...
                                <div className="BTC">
                                    ...
                                    <div style={{ fontSize: "18px" }}>Available: <span style={{ fontWeight: "bold" }}>0.00000000 BTC</span></div>
                                </div>
                                <div className="imgswap">
                                    <div className="swapswap"><img src={swapswap} alt="" /></div>
                                </div>
                                <div className="USDT">
                                    <div>Amount of USDT:</div>
                                    <div className="USDT-main">
                                        <div className="USDT-main_num">0.0</div>
                            ...
                            <div className="table-main_note">
                                <div className="rate">
                                    <div>
                                        <div>Rate:</div>
                                        <div>
                                            <div><span style={{ fontWeight: "bold" }}>1</span> BTC = <span style={{ fontWeight: "bold" }}>28,490.64</span> USDT</div>
                                            <img src={traodoi} alt="" />
                                        </div>
                                    </div>
                                    <div>
                                ...
                                <div><img src={thanhcheck} alt="" /></div>
                                <div className="Esti">
                                    <div>
                                        <div>Estimated Gas Fee</div>
                                        <div style={{ fontWeight: "bold" }}>0.00045 BNB ~ $0.11</div>
                                    </div>
                                    <div>
